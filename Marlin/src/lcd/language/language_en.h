...
namespace Language_en {
  ...
  PROGMEM Language_Str MSG_AUTO_HOME_A                     = _UxGT("Home ALL");
  ...
  PROGMEM Language_Str MSG_X_HOME_OFFSET                   = _UxGT("X Home Offset");
  PROGMEM Language_Str MSG_Y_HOME_OFFSET                   = _UxGT("Y Home Offsets");
  PROGMEM Language_Str MSG_Z_HOME_OFFSET                   = _UxGT("Z Home Offsets");
  PROGMEM Language_Str MSG_COATING_THICKNESS			   = _UxGT("Coating thickness");
  ...
  PROGMEM Language_Str MSG_CATCH_PROBE_Z_OFFSET            = _UxGT("Catch Z Offset");
  ...
  PROGMEM Language_Str MSG_MOVE                            = _UxGT("Move");
  ...
  PROGMEM Language_Str MSG_MOVE_E1                         = _UxGT("Extruder1");
  PROGMEM Language_Str MSG_MOVE_E2                         = _UxGT("Extruder2");
  PROGMEM Language_Str MSG_MOVE_E3                         = _UxGT("Extruder3");
  PROGMEM Language_Str MSG_MOVE_E4                         = _UxGT("Extruder4");
  ...
  PROGMEM Language_Str MSG_INFO_MACHINE                    = _UxGT("Info");
  PROGMEM Language_Str MSG_PREPARE                         = _UxGT("Prepare");
  PROGMEM Language_Str MSG_TUNE                            = _UxGT("Tune");
  PROGMEM Language_Str MSG_PAUSE                           = _UxGT("Pause");
  ...
  PROGMEM Language_Str MSG_HEIGHT                          = _UxGT("Height");
  ...
  PROGMEM Language_Str MSG_MIXER_MANUAL                    = _UxGT("Manual");
  PROGMEM Language_Str MSG_MIXER_AUTO                      = _UxGT("Auto");
  PROGMEM Language_Str MSG_MIXER_RANDOM                    = _UxGT("Random");
  PROGMEM Language_Str MSG_GRADIENT                        = _UxGT("GradientMix");
  PROGMEM Language_Str MSG_RANDOMMIX                       = _UxGT("Random Mix");
