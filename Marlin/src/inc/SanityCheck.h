 ...
 */
#if ENABLED(SWITCH_EXTRUDER_MENU) && !ALL(MIXING_EXTRUDER, OPTION_MIXING_SWITCH, ZONESTAR_DWIN_LCD)
	#error "SWITCH_EXTRUDER_MENU require MIXING_EXTRUDER & OPTION_MIXING_SWITCH & ZONESTAR_DWIN_LCD"
#endif

#if ENABLED(SWITCH_EXTRUDER_MENU) && (ENABLED(MIXING_EXTRUDER) && (MIXING_STEPPERS != 3) && (MIXING_STEPPERS != 4))
	#error "SWITCH_EXTRUDER_MENU only work on 3 & 4 extruders machine"
#endif

#if ENABLED(OPTION_MIXING_SWITCH) && DISABLED(MIXING_EXTRUDER)
	#error "OPTION_MIXING_SWITCH require MIXING_EXTRUDER"
#endif
	...
	#error "Disable OPTION_WIFI_BAUDRATE if you want to use DEBUG_OUT_TO_WIFI"
#endif

#if ENABLED(OPTION_Z2_ENDSTOP) && DISABLED(OPTION_DUALZ_DRIVE)
 ...
 */
  ...
  #error "PETG_PREHEAT_HOTEND_TEMP is now PREHEAT_3_TEMP_HOTEND. Please update your configuration."
  ...
  #error "ANET_KEYPAD_LCD is now ZONESTAR_LCD2004_ADCKEY. Please update your configuration."
...
#elif defined(SERIAL_PORT_2) && defined(LCD_SERIAL_PORT)
  #error "SERIAL_PORT_2 with LCD_SERIAL_PORT can't exist at the same time. Please update your configuration."
#endif
...
#if ENABLED(SHOW_CUSTOM_BOOTSCREEN) && NONE(HAS_MARLINUI_U8GLIB, TOUCH_UI_FTDI_EVE,HAS_DWIN_LCD)
  #error "SHOW_CUSTOM_BOOTSCREEN requires Graphical LCD or TOUCH_UI_FTDI_EVE."
#elif ENABLED(CUSTOM_STATUS_SCREEN_IMAGE) && !HAS_MARLINUI_U8GLIB && !HAS_DWIN_LCD
 ...
 */
  ...
  #elif !(ENABLED(MESH_BED_LEVELING) || HAS_ABL_NOT_UBL) && !HAS_DWIN_LCD
 ...
 */
  ...
  + COUNT_ENABLED(ENDER2_STOCKDISPLAY, CR10_STOCKDISPLAY, HAS_DWIN_LCD) \
